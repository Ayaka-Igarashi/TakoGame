...
//テキスト
public class GameText_end extends GameItem{
	...
	private String[] nowText=new String[GameText_end.gyoNum];//現在の表示テキスト
...
*/
	...
	public GameItem draw(TWInfo tInfo) {
		...
		for(int i=0;i<gameTexts[nowTextNum].length;i++) {
			this.drawStr(tInfo, this.nowText[i], 155, 470+i*GameText_end.gyoSp);
